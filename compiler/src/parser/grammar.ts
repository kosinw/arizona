...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "ElseStatement", "symbols": ["ELSE", "_", "Block"], "postprocess": syntax.else},
    {"name": "ElseStatement", "symbols": ["ELSE", "_", "IfStatement"], "postprocess": syntax.else},
    ...
    {"name": "ForStatement", "symbols": ["FOR", "_", "LP", "_", "_Assignment", "TERMINATOR", "_", "Expression", "TERMINATOR", "_", "_Assignment", "_", "RP", "_", "Block"], "postprocess": syntax.for},
    {"name": "ForStatement", "symbols": ["FOR", "_", "VariableDeclaration", "_", "Expression", "TERMINATOR", "_", "_Assignment", "_", "Block"], "postprocess": syntax.for},
    {"name": "ForStatement", "symbols": ["FOR", "_", "LP", "_", "VariableDeclaration", "_", "Expression", "TERMINATOR", "_", "_Assignment", "_", "RP", "_", "Block"], "postprocess": syntax.for},
    ...
    {"name": "Program", "symbols": ["_"], "postprocess": compose(syntax.node(SyntaxType.RootNode), flatten)},
    {"name": "Program", "symbols": ["_", "TopLevelDeclarations", "_"], "postprocess": compose(syntax.node(SyntaxType.RootNode), flatten)},
    ...
    {"name": "Export", "symbols": ["EXPORT", "__", "GlobalImmutableDeclaration"], "postprocess": syntax.node(SyntaxType.Export)},
    {"name": "Export", "symbols": ["EXPORT", "__", "FunctionDeclaration"], "postprocess": syntax.node(SyntaxType.Export)},
    {"name": "Export", "symbols": ["EXPORT", "__", "GlobalVariableDeclaration"], "postprocess": syntax.node(SyntaxType.Export)},
    ...
    {"name": "FunctionHeaderDeclaration", "symbols": ["FN", "__", "Identifier", "_", "FunctionParameters"], "postprocess": syntax.fnheader},
    {"name": "FunctionHeaderDeclaration", "symbols": ["FN", "__", "Identifier", "_", "FunctionParameters", "_", "FunctionResult"], "postprocess": syntax.fnheader},
    ...
    {"name": "GlobalVariableDeclaration", "symbols": ["LET", "_", "NameAndType", "_", "EQUALS", "_", "Expression", "TERMINATOR"], "postprocess": syntax.declaration(SyntaxType.GlobalVariableDeclaration)},
    ...
    {"name": "GlobalImmutableDeclaration", "symbols": ["CONST", "_", "NameAndType", "_", "EQUALS", "_", "Expression", "TERMINATOR"], "postprocess": syntax.declaration(SyntaxType.GlobalImmutableDeclaration)},
    ...
    {"name": "Product", "symbols": ["Product", "_", {"literal":"*"}, "_", "Typecast"], "postprocess": syntax.binary},
    {"name": "Product", "symbols": ["Product", "_", {"literal":"/"}, "_", "Typecast"], "postprocess": syntax.binary},
    {"name": "Product", "symbols": ["Product", "_", {"literal":"%"}, "_", "Typecast"], "postprocess": syntax.binary},
    {"name": "Product", "symbols": ["Typecast"], "postprocess": id},
    {"name": "Typecast", "symbols": ["LANGLE", "_", "DeclType", "_", "RANGLE", "_", "Unary"], "postprocess": syntax.typecast},
